...
//   cyberchief_bolt(
//     {
//         key: "bolt.i3SMnhMJIMIw43A5nd72KxcpIbYBCIeVk2OZb08j",
...
app.use(
  cyberchief_bolt(
      {
          key: "bolt.y75STUQbf96ZE06xBgTGOmID0iGOOhiYh63xcQ16",
          host: "http://bolt-staging-719932934.us-east-2.elb.amazonaws.com:8081",
      })); 
...
//   cyberchief_bolt(
//       {
//           key: "bolt.KVlTOnlIy2YJCDuAunaZAJaZzzsjUaXoJDpfYAhT",
//           host: "http://bolt-staging-719932934.us-east-2.elb.amazonaws.com:8081",
//       })); 
...
app.get('/api/products/:id', (req, res) => {
  res.json({ id: req.params.id, name: `Product ${req.params.id}`, price: 29.99 });
});
